...
class LDA:
    def __init__(self, K, alpha, beta, docs, V, smartinit=True):
        ...
        #print "word count of each topic and vocabulary, n_z_t:", self.n_z_t  
        #print "word count of each topic, n_z:", self.n_z 
    ...
    def worddist(self):
        ...
        #print "Denominador Worddist:", self.n_z[:, numpy.newaxis]
